...
defines({ "_WIN32" })
links({ "winmm", "gdi32", "opengl32", "cudart" })
libdirs({ "../bin/%{cfg.buildcfg}", "/opt/cuda/targets/x86_64-linux/lib" })

filter("system:linux")
links({ "pthread", "m", "dl", "rt", "X11", "cudart" })
libdirs({ "/opt/cuda/targets/x86_64-linux/lib" })
